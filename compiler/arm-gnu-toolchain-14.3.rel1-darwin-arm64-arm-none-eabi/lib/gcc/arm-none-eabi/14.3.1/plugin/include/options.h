...
enum opt_code
{
  ...
  OPT_mcpu_ = 1972,                          /* -mcpu= */
  OPT_mdlstp = 1973,                         /* -mdlstp */
  OPT_mfdpic = 1974,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1975,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1976,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1977, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1978,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1979,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1980,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1981,                  /* -mfp16-format= */
  OPT_mfpu_ = 1982,                          /* -mfpu= */
  ...
  OPT_mneon_for_64bits = 1988,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1989,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1990,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1991,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1992,               /* -mprint-tune-info */
  OPT_mpure_code = 1993,                     /* -mpure-code */
  OPT_mrestrict_it = 1994,                   /* -mrestrict-it */
  OPT_msched_prolog = 1995,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1996,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1997,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1998, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 1999, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 2000,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 2001,      /* -mstructure-size-boundary= */
  OPT_mthumb = 2002,                         /* -mthumb */
  OPT_mthumb_interwork = 2003,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 2004,                  /* -mtls-dialect= */
  OPT_mtp_ = 2005,                           /* -mtp= */
  OPT_mtpcs_frame = 2006,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 2007,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 2008,                         /* -mtune= */
  OPT_munaligned_access = 2009,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 2010,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 2011,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 2012,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 2013,              /* -mword-relocations */
  OPT_n = 2014,                              /* -n */
  OPT_name_sort = 2015,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2016,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2017,              /* -no-integrated-cpp */
  OPT_no_pie = 2018,                         /* -no-pie */
  OPT_nocpp = 2019,                          /* -nocpp */
  OPT_nodefaultlibs = 2020,                  /* -nodefaultlibs */
  OPT_nolibc = 2021,                         /* -nolibc */
  OPT_nophoboslib = 2022,                    /* -nophoboslib */
  OPT_nostartfiles = 2023,                   /* -nostartfiles */
  OPT_nostdinc = 2024,                       /* -nostdinc */
  OPT_nostdinc__ = 2025,                     /* -nostdinc++ */
  OPT_nostdlib = 2026,                       /* -nostdlib */
  OPT_nostdlib__ = 2027,                     /* -nostdlib++ */
  OPT_o = 2028,                              /* -o */
  OPT_objects = 2029,                        /* -objects */
  OPT_p = 2030,                              /* -p */
  OPT_pass_exit_codes = 2031,                /* -pass-exit-codes */
  /* OPT_pedantic = 2032, */                 /* -pedantic */
  OPT_pedantic_errors = 2033,                /* -pedantic-errors */
  OPT_pg = 2034,                             /* -pg */
  OPT_pie = 2035,                            /* -pie */
  OPT_pipe = 2036,                           /* -pipe */
  OPT_print_file_name_ = 2037,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2038,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2039,          /* -print-multi-directory */
  OPT_print_multi_lib = 2040,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2041,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2042,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2043,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2044,               /* -print-prog-name= */
  OPT_print_search_dirs = 2045,              /* -print-search-dirs */
  OPT_print_sysroot = 2046,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2047,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2048,                    /* -print-value */
